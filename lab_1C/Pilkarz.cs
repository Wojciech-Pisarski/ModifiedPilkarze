...
namespace lab_1C
{
    internal class Pilkarz
    {
        ...
        public Pilkarz zmianaPilkarz(Pilkarz pilkarzDane)
        {
            this.Imie = pilkarzDane.Imie;
            this.Nazwisko = pilkarzDane.Nazwisko;
            this.Wiek = pilkarzDane.Wiek;
            this.Waga = pilkarzDane.Waga;
            return this;
        }
